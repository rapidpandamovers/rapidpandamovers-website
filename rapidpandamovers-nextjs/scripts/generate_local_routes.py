...
Usage:
  python generate_local_routes.py \
    --input areas.json \
    --outcsv local_routes.csv \
    --outjson local_routes.json
"""
...
def main():
    ...
    parser.add_argument("--outcsv", default="data/local_routes.csv")
    parser.add_argument("--outjson", default="data/local_routes.json")
