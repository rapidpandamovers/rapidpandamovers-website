...
export default function FeaturedPostCard({ post }: FeaturedPostCardProps) {
  ...
  return (
    <article className="bg-orange-500 rounded-4xl overflow-hidden text-white group">
      ...
      <div className="lg:col-span-2 flex flex-col justify-center p-8 lg:py-8 lg:pr-8 lg:pl-0">
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-4">
          <BlogPostLink href={`/blog/${post.slug}`} className="hover:text-orange-100 transition-colors">
            {post.title}
          </BlogPostLink>
        </h2>
        ...
        <BlogPostLink
          href={`/blog/${post.slug}`}
          className="inline-flex items-center bg-white text-orange-600 font-semibold px-6 py-3 rounded-lg hover:bg-orange-50 transition-colors w-fit"
        >
          Read Full Article
