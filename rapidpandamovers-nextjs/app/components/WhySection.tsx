import { Shield, Users, DollarSign, Clock, Phone, CheckCircle, LucideIcon } from 'lucide-react'
        ...
        <div className="bg-gray-100 rounded-4xl p-8 md:p-12">
          ...
          {displayCtaLink && (
            <div className="text-center mt-10">
              <Link href={displayCtaLink} className="bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 px-8 rounded-lg transition-colors">
                {displayCtaText}
              </Link>
            </div>
          )}
