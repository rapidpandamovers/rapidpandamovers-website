---
id: 214
title: "Slate vs MDF Pool Tables: How Moving Differs"
slug: "slate-vs-mdf-pool-tables-how-moving-differs"
excerpt: "Not all pool tables are built the same, and the material under the felt makes a huge difference when it comes time to move."
date: "2025-09-01"
updated: "2025-09-01"
readTime: "5 min read"
...
- **Check the weight**: Try pushing the table. If it barely budges, you almost certainly have slate. A 7-foot slate table weighs 700 to 800 pounds. An MDF table of the same size weighs 200 to 350 pounds.
- **Knock on the surface**: Slate produces a dull, dense thud. MDF has a lighter, more hollow sound.
- **Look at the price tag**: If you paid under $1,500 for a new table, it's likely MDF. Slate tables typically start around $2,000 and go up from there.
- **Check underneath**: If you can access the underside, slate has a rough, gray stone surface. MDF looks like compressed wood fiber.

## Moving a Slate Pool Table

Slate is the premium choice for pool tables because it provides the flattest, most consistent playing surface available. But that quality comes with serious weight and fragility. Here's how our [**Pool Table Moving**](/pool-table-moving) team handles slate:
...
- More crew members are needed for the heavier slate pieces
- Disassembly and reassembly takes longer (3-4 hours for slate vs. 1.5-2 hours for MDF)
- Specialized slate-handling equipment is required
- Precision leveling with beeswax seam filling adds time
...
- **Expertise**: We know the specific handling requirements for both slate and MDF surfaces
- **Equipment**: Slate jacks, moisture barriers, and specialized dollies for every table type
- **Insurance**: Coverage for your table regardless of its construction
- **Efficiency**: Right-sized crew and timeline based on your specific table

## Ready to Get Started?

**[Request your free quote](/quote)** today. Read our **[customer reviews](/reviews)** to see why Miami families trust Rapid Panda Movers with their pool tables, whether they're premium slate or budget-friendly MDF.
